...
> - ### **黑板中创建受击的 bool**
>
>   - #### **命名为 `HitReacting`，默认为 `false*`**![img](./GAS_079/4.png)
>
> - #### 接下来去敌人中设置
>
>   - #### **`设置初始值` 为 `false`**
...
>     ```
>
>     ![img](./GAS_079/5.png)![img](./GAS_079/6.png)
>     
>     
>     
>     ```cpp
...
>
> - #### 只有该 bool == false 时，才会执行下面的节点；否则失败返回![img](./GAS_079/7.png)
...
> #### 因为上级是select节点，所以只会选择一个执行![img](./GAS_079/9.png)
...
> #### 只有当设置为 远程bool RangedAttacker == true 时才会执行下面的逻辑![img](./GAS_079/11.png)
...
>
> - #### 距离小于500时，激活下面的节点![img](./GAS_079/12.png)
