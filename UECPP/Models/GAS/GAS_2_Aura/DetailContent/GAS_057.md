...
>![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/1.png?raw=true)
___________________________________________________________________________________________
...
> 小测试1步骤：
> 1. `Content/BP/GameplayEffects/AbilitySystem/`下创建GE![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/2.png?raw=true)
>
...
>    ```
>
> 3. 在 *GE_HitReact* 中授予Tag![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/3.png?raw=true)
...
> ```
>
> 调用这个函数时会返回一个委托的引用 `FOnGameplayEffectTagCountChanged&` ![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/4.png?raw=true)![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/5.png?raw=true)参数分别为(要监听的Tag,当前Tag 新的标签计数[1^] )
>
...
+ `源文件`中：`BeginPlay`时绑定`监听Tag变化的回调`![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/6.png?raw=true)
...
还需要在`BeginPlay函数中`设置敌人的移动速度为`BaseWalkSpeed`![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/7.png?raw=true)
...
>     ![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/8.png?raw=true)
___________________________________________________________________________________________
...
> 步骤：
> 1. 在`Content/BP/AbilitySystem/GameplayAbilities/`文件夹下，创建GA，命名为：*GA_HitReact*![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/9.png?raw=true)
>
...
>    ```
>
>    ![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/10.png?raw=true)
>
>
> 3. 保存`Handle`便于移除![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/11.png?raw=true)
>
> **因为蒙太奇每个对象都不一样，可以配置，所以最好做成每个对象都有的变量，使用接口调用获取**![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/12.png?raw=true)
>
...
>      ```
>
> 6. 蓝图中调用![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/13.png?raw=true)
>
> 7. 需要配置蒙太奇了，还没有，需要创建一下，敌人的角色动画蓝图中别忘了加插槽，为敌人创建蒙太奇并配置![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/14.png?raw=true)![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/15.png?raw=true)![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/16.png?raw=true)![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/17.png?raw=true)![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/18.png?raw=true)
...
> 1. 何时学习GA?
>
>    1. 之前在`AAuraCharacterBase` 中创建了`AddCharacterAbilities`函数用来给角色赋予技能![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/19.png?raw=true)
>
>    2. 调用`UAuraAbilitySystemComponent`中`AddCharacterAbilities`函数
>
>       `有参构造`了一个`FGameplayAbilitySpec` ，并在应用前，添加了一个动态标签`DynamicAbilityTags`，因为敌人没有输入标签tag所以不需要添加动态标签，动态标签只适用于玩家。![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/20.png?raw=true)
...
>   1. 蓝图函数库类`UAuraAbilitySystemLibrary`中创建了函数`InitializeDefaultAttributes`来初始化![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/21.png?raw=true)
...
![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/22.png?raw=true)

现在敌人已学会他们的共同能力，需要在AS的后处理函数`PostGameplayEffectExecute`中激活技能

![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/23.png?raw=true)
...
>
> - 可以使用Tag标签来激活拥有该Tag的能力，使用API:`Props.TargetASC->TryActivateAbilitiesByTag`![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/24.png?raw=true)
>
>   ```CPP
...
![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/25.png?raw=true)
...
![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/26.png?raw=true)
...
![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/27.gif?raw=true)

___________________________________________________________________________________________

### 在蒙太奇中缩短敌人受击动画混入混出时间

![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/28.png?raw=true)![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/29.png?raw=true)
...
> 在这里![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/30.png?raw=true)
>
> |     GA的实例化策略      |                        作用                        |
> | :---------------------: | :------------------------------------------------: |
...
![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/31.gif?raw=true)
___________________________________________________________________________________________

### 当蒙太奇播放几种情况下，都该结束技能，移除该tag
![](https://github.com/liyunlong618/LiYunLongKnowledgeLibrary/blob/main/UECPP/Models/GAS/GAS_2_Aura/DetailContent/Image/GAS_057/32.png?raw=true)
